...
class CoinSpider(Spider):
    ...
    def start_requests(self):
        ...
        data = {'stockcode' : stock, 'pageSize':'10', 'pageNum':'1', 'orgId' : 'gssz0000009'}
        yield FormRequest(url = start_url, formdata = data, callback = self.parse, meta = {'page':1, 'stkcd':stock, 'orgId':'gssz0000009'})
